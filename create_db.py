...
def create_database():
    ...
    armoured_data = [
        ...
        ("E1SW", "20L",  6.5, 13.9, 13, 20.5),
        ("E1SW", "25S", 11.1, 16.5, 13, 20.5),
        ("E1SW", "25L", 14.5, 20, 18.5, 26.0),
        ("E1SW", "32", 17.2, 26.2, 24.0, 33.5),
        ("E1SW", "40", 23.5, 32, 28, 40.0),
        ("E1SW", "50S", 32, 37.0, 35.5, 46.5),
        ("E1SW", "50L", 36.7, 43, 41, 53),
        ("E1SW", "63S", 42.7, 50, 46, 59),
        ("E1SW", "63L", 49.5, 55, 55, 65.5),
        ("E1SW", "75S", 54.5, 60.9, 59.5, 72),
        ("E1SW", "75L", 60.9, 67, 67, 78),
        ("E1SW", "90",   65, 78, 76.5,90),
